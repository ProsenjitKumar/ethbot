...
EMAIL_HOST = 'mail.cryptoethbot.com'  #Hosted on namecheap Ex: mail.pure.com
EMAIL_USE_TLS = False
EMAIL_PORT = 26 #This will be different based on your Host, for Namecheap I use this`
EMAIL_HOST_USER = 'no-reply@cryptoethbot.com' # Ex: info@pure.com
EMAIL_HOST_PASSWORD = 'r[.dHdm9j*SG' # for the email you created through cPanel. The password for that
